...
class RatingsViewController: UIViewController,UIWebViewDelegate, UIScrollViewDelegate {
    ...
    func sleep() {
        ...
        resetTimer()
        performSegueWithIdentifier("ratingstosleepsegue", sender: nil)
    }
    ...
    let url = "http://www.float-schwabing.de/guestbook"
